...
class Parse:
    ...
    def parse_emc(self, lookup_table, emc):
        ...
        lookup_table['EMC Frequency (MHz)'] = float(emc[1])  if emc[1] else ''
        return lookup_table
    ...
    def parse_file(self):
        ...
        with open(csv_file, 'w', newline='') as fopen:
            ...
            with open(self.log_file, 'r') as log:
                ...
                for i, line in enumerate(data[0:]): # changed from data[1:] to data[0:] to include initial line log (0 ms)
